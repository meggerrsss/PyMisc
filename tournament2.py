...
new = ['flarrow','chicago','criminal minds','ncis','new girl','gotham','motive','once upon a time','scorpion','sherlock','big bang theory','night shift','vamporiginals','whose line','izombie','librarians','cyber','daredevil']
...
both = shows+books
inactive = ['new girl','gotham','flarrow','sherlock','criminal minds','ncis','once upon a time','scorpion']
